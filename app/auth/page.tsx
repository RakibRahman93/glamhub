            ...
            <AnimatedSection>
              <Card className="bg-white shadow-2xl border-0 overflow-hidden">
                <CardContent className="p-0">
                  {/* Header Section */}
                  <div className="bg-gradient-to-r from-saloon-brown to-saloon-dark-brown p-8 text-center text-white mx-auto">
                    <motion.div
                    ...
                    >
                      ...
                      />
                      <p className="font-gilroy-regular text-saloon-brown">
                        {isLogin
